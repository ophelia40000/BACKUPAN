...
class SearchScreen extends StatelessWidget {
  ...
  Positioned posisi(double atas,String isi,String jumlah){
    return Positioned(
              //isi 1
              top: atas,
              left: 0,
      ...
      appBar: AppBar(
       ...
       body: Stack(
          children: [
            ...
            posisi(80, "Hujan","46.7K posts"),
            posisi(200, "#SalmaSalsabil", "29.6K posts"),
            posisi(320, "Monas","10.8K posts"),
            posisi(440, "#GGMU", "2.200 posts"),
            Positioned(
              //showmore
              top: 540,
              left: 0,
